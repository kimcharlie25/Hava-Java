  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center mb-8">
        ...
        <h1 className="text-3xl font-more-sugar font-semibold text-black ml-8">Payment</h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <button
            ...
            className="w-full py-4 rounded-xl font-medium text-lg transition-all duration-200 transform bg-hava-yellow text-black hover:bg-yellow-400 hover:scale-[1.02]"
          >
