...
const FloatingCartButton: React.FC<FloatingCartButtonProps> = ({ itemCount, onCartClick }) => {
  ...
  return (
    <button
      onClick={onCartClick}
      className="fixed bottom-6 right-6 bg-hava-yellow text-black p-4 rounded-full shadow-lg hover:bg-yellow-400 transition-all duration-200 transform hover:scale-110 z-40 md:hidden"
    >
